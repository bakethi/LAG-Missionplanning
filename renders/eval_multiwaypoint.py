...
base_filename = f"{experiment_name}"
acmi_filepath = os.path.join(acmi_dir, f"{base_filename}.acmi")
...
heatmap_path = os.path.join(acmi_dir, f"{base_filename}_heatmap.png")
